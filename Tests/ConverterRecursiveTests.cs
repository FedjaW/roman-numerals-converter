...
public class ConverterRecursiveTests
{
    ...
    public string ConvertToRoman_Integer_ReturnsRoman(int numberToConvert)
    {
        ...
        // Act
        var romanNumber = ConverterRecursive.ConvertToRoman(numberToConvert);
    ...
    public void ConvertToRoman_GreaterThan3999_ThrowsException(int numberToConvert)
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentOutOfRangeException>(() => ConverterRecursive.ConvertToRoman(numberToConvert));
    }
