...
public class ConverterUnadornedTests
{
    ...
    public string ConvertToRoman_Integer_ReturnsRoman(int numberToConvert)
    {
        ...
        // Act
        var romanNumber = ConverterUnadorned.ConvertToRoman(numberToConvert);
    ...
    public void ConvertToRoman_GreaterThan3999_ThrowsException(int numberToConvert)
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentOutOfRangeException>(() => ConverterUnadorned.ConvertToRoman(numberToConvert));
    }
